...
public class NewRewardPage extends BasePage {

	private static final Logger log = Logger.getLogger(NewRewardPage.class.getName());

	public NewRewardPage(WebDriver driver) {
		super(driver);
